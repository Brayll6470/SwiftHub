...
5. Open the file to start SwiftHub.
...
2. Read any prompts on screen.
3. Pick the tasks you want to use.
4. Allow access if Windows asks for it.
5. Keep the app in a place you can reach fast, such as the desktop.
...
5. Use SwiftHub to run your task
